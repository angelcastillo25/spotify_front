    ...
    <main>
        <div class="list_header">
            ...
            <div class="cover_container">
                <img src="https://storage.googleapis.com/spt-project-bucket/{{$episodio->portada}}" class="cover_img" alt="portada list" id="list_cover">
            </div>
            <div class="list_header_panel">
                ...
                <div class="creator_container">
                    <img src="https://storage.googleapis.com/spt-project-bucket/{{$episodio->portada}}" alt="usuario" class="profile_image">
